...
/**
 * This is the model class for table "kdt_ranh".
 *
 * @property int $id
 ...
 */
class KdtRanh extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['geom'], 'string'],
            [['OBJECTID', 'FID_Polygo', 'LyrFrzn', 'LyrLock', 'LyrOn', 'LyrVPFrzn', 'Color', 'EntColor', 'LyrColor', 'BlkColor', 'LineWt', 'EntLineWt', 'LyrLineWt', 'BlkLineWt'], 'default', 'value' => null],
            [['OBJECTID', 'FID_Polygo', 'LyrFrzn', 'LyrLock', 'LyrOn', 'LyrVPFrzn', 'Color', 'EntColor', 'LyrColor', 'BlkColor', 'LineWt', 'EntLineWt', 'LyrLineWt', 'BlkLineWt'], 'integer'],
            [['Elevation', 'Thickness', 'LTScale', 'ExtX', 'ExtY', 'ExtZ', 'Shape_Leng'], 'number'],
            [['Entity', 'Handle', 'LyrHandle', 'DocVer'], 'string', 'max' => 16],
            [['Layer', 'Linetype', 'EntLinetyp', 'LyrLnType', 'BlkLinetyp', 'RefName', 'DocName', 'DocPath'], 'string', 'max' => 254],
