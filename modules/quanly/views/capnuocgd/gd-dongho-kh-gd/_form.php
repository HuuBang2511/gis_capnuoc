 ...
 * @var app\models\GdDonghoKhGd $model
    ...
    <div class="block block-themed">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'ngaybamchi')->widget(DatePicker::class) ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <?= $form->field($model, 'ngaycapnha')->widget(DatePicker::class) ?>
                </div>
                <div class="col-lg-3">
...
// Cấu hình các lớp WMS (tương tự form trước)
