                                                ...
                                                switch (layerName) {
                                                    ...
                                                    case 'v2_4326_ONGTRUYENDAN':
                                                        var popupContent = "<div class='popup-content'>" +
                                                            ...
                                                            "<tr><td><strong>Tên công trình:</strong></td><td>" + properties.tencongtri + "</td></tr>" +
                                                            "<tr><td><strong>Năm lắp đặt:</strong></td><td>" + properties.namlapdat + "</td></tr>" +
                                                            "<tr><td><strong>Đơn vị thiết kế:</strong></td><td>" + properties.donvithiet + "</td></tr>" +
                                                            "<tr><td><strong>Đơn vị thi công:</strong></td><td>" + properties.donvithico + "</td></tr>" +
                                                            "</table>" +
                                                            "</div>";
                                                        break;
...
var legendToggleControl = L.control({ position: 'bottomright' });
...
<style>
    /* CSS for popup table */
    .popup-content {
        max-width: 100%; /* Đảm bảo popup không vượt quá chiều rộng của màn hình */
        overflow-x: auto; /* Cho phép người dùng cuộn ngang nếu nội dung quá rộng */
    }
    ...
    .popup-table td {
        padding: 8px;
        border-bottom: 1px solid #ddd; /* Đường viền dưới của mỗi hàng */
    }
    ...
    .popup-table th:hover {
        background-color: #ddd; /* Màu nền khi di chuột qua tiêu đề cột */
    }
